    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('door_id', models.CharField(default='', max_length=32, null=True)),
                ('singleRoom_id', models.CharField(default='', max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college', models.CharField(default='', max_length=32, null=True)),
                ('tel', models.CharField(default='', max_length=16, null=True)),
                ('a', models.CharField(default='', max_length=16, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Warning',
